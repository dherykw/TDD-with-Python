...
class LoginViewTest(TestCase):
    ...
    def test_calls_authenticate_with_assertion_from_post(self, mock_autenticate):
        mock_autenticate.return_value = None
        self.client.post('/accounts/login', {'assertion': 'assert this'})
        mock_autenticate.assert_called_once_with(assertion='assert this')

    @patch('accounts.views.authenticate')
    def test_returns_OK_when_use_found(self, mock_authenticate):
