...
from list.forms import ItemForm, EMPTY_ITEM_ERROR, DUPLICATE_ITEM_ERROR, ExistingListItemForm, NewListForm
...
class ItemFormTest(TestCase):
    ...
    def test_form_validation_for_blanks_items(self):
...
class NewListFormTest(unittest.TestCase):
    @patch('list.forms.List.create_new')
