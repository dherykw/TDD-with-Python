...
class HomePageTest(TestCase):
    ...
    def test_home_page_returns_correct_html(self):
        ...
        expected_html = render_to_string('list/home.html')
...
class NewListTest(TestCase):
    ...
    def test_validation_errors_are_sent_back_to_home_page_template(self):
        ...
        error_expected = escape("You can't have any empty list item")
        self.assertContains(response, error_expected)
...
class NewItemTest(TestCase):
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post(
            ...
            data={'item_text': 'A new item fot an existing list'}
        )

        self.assertEqual(Item.objects.count(), 1)
        new_item = Item.objects.first()
        self.assertEqual(new_item.text, 'A new item fot an existing list')
        self.assertEqual(new_item.list.id, correct_list.id)
